...
export const Vortex = (props: VortexProps) => {
  ...
  return (
    <div className={cn('relative h-full w-full', props.containerClassName)}>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} ref={containerRef} className='absolute inset-0 z-0 flex h-full w-full items-center justify-center bg-transparent'>
